...
def main():
    ...
    while True:
        ...
        if simulation == 'separation' or simulation == 'collision':
            file = '../figures/test/simulation_gw'
    ...
    while True:
        simulation = update_classical_no_gw(compact_object_1, compact_object_2, time_step, initial_distance)
        if simulation == 'separation' or simulation == 'collision':
            file = '../figures/test/simulation_no_gw'
