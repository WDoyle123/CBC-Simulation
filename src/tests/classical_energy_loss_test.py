...
def main():
    ...
    compact_object_2 = CompactObject(x=separation, y=separation, z=separation, mass=mass_2, radius=radius_2, object_type="Black Hole", velocity_x=-0.001, velocity_y=-0.001, velocity_z=-0.001)
    ...
    compact_object_3 = CompactObject(x=0., y=0., z=0., mass=mass_1, radius=radius_1, object_type="Black Hole", velocity_x=0.01, velocity_y=0.05, velocity_z=0.05)
    compact_object_4 = CompactObject(x=separation, y=separation, z=separation, mass=mass_2, radius=radius_2, object_type="Black Hole", velocity_x=-0.00, velocity_y=-0.00, velocity_z=-0.00)
